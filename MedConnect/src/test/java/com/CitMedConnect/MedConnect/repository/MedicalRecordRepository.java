package test.java.com.CitMedConnect.MedConnect.repository;
...
public interface MedicalRecordRepository extends JpaRepository<MedicalRecordEntity, Long> {
    ...
    List<MedicalRecordEntity> findByUser_SchoolId(int schoolId);
    ...
    List<MedicalRecordEntity> findByUser_SchoolIdOrderByRecordDateDesc(int schoolId);
