package test.java.com.CitMedConnect.MedConnect.service;

import com.CitMedConnect.MedConnect.entity.MedicalRecordEntity;
import com.CitMedConnect.MedConnect.entity.UserEntity;
import com.CitMedConnect.MedConnect.entity.AppointmentEntity;
import com.CitMedConnect.MedConnect.repository.MedicalRecordRepository;
import com.CitMedConnect.MedConnect.repository.UserRepository;
import com.CitMedConnect.MedConnect.repository.AppointmentRepository;
...
public class MedicalRecordService {
    ...
    public MedicalRecordEntity createMedicalRecord(MedicalRecordEntity medicalRecord) {
        ...
        if (medicalRecord.getUser() != null) {
            UserEntity user = userRepository.findById(medicalRecord.getUser().getSchoolId()).orElse(null);
            if (user == null) {
    ...
    public List<MedicalRecordEntity> getMedicalRecordsByUserId(int userId) {
        return medicalRecordRepository.findByUser_SchoolId(userId);
    }
    
    // Get medical records by user ID ordered by date
    public List<MedicalRecordEntity> getMedicalRecordsByUserIdSorted(int userId) {
    ...
    public List<MedicalRecordEntity> getMedicalRecordsByUserAndDateRange(int userId, LocalDateTime startDate, LocalDateTime endDate) {
    ...
    public long getRecordCountByUserId(int userId) {
        UserEntity user = userRepository.findById(userId).orElse(null);
        if (user == null) {
            return 0;
        }
