package test.java.com.CitMedConnect.MedConnect.controller;

import com.CitMedConnect.MedConnect.entity.MedicalRecordEntity;
import com.CitMedConnect.MedConnect.service.MedicalRecordService;
...
public class MedicalRecordController {
    ...
    public List<MedicalRecordEntity> getMedicalRecordsByUserId(@PathVariable int userId) {
    ...
    public List<MedicalRecordEntity> getMedicalRecordsByUserIdSorted(@PathVariable int userId) {
    ...
    public long getRecordCountByUserId(@PathVariable int userId) {
